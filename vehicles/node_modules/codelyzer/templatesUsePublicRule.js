...
var SymbolAccessValidator = (function (_super) {
    ...
    SymbolAccessValidator.prototype.doCheck = function (ast, type, context) {
        ...
        var allMembers = classDeclarationUtils_1.getClassMembers(this.context.controller, this.languageService.getProgram().getTypeChecker())
            .map(function (s) { return s.declarations[0]; });
...
var Rule = (function (_super) {
    ...
    Rule.prototype.applyWithProgram = function (sourceFile, languageService) {
        var sf = languageService.getProgram().getSourceFiles().filter(function (sf) { return sf.fileName === sourceFile.fileName; }).pop();
        return this.applyWithWalker(new ng2Walker_1.Ng2Walker(sf, this.getOptions(), {
