...
var ProviderSymbol = (function (_super) {
    __extends$1(ProviderSymbol, _super);
    function ProviderSymbol(program, provider, metadataResovler) {
        var _this = _super.call(this, program, provider.token.identifier.reference) || this;
        _this.provider = provider;
        _this.metadataResovler = metadataResovler;
        return _this;
    }
    ...
    ProviderSymbol.prototype.getDependencies = function () {
        ...
        return (this.provider.deps || []).map(function (d) {
            var meta = new _angular_compiler.ProviderMeta(d.token.identifier.reference, d);
            return new ProviderSymbol(_this._program, _this.metadataResovler.getProviderMetadata(meta), _this.metadataResovler);
        });
    };
...
var CssStyleValueAst = (function (_super) {
    __extends$4(CssStyleValueAst, _super);
...
var CssBlockRuleAst = (function (_super) {
    __extends$4(CssBlockRuleAst, _super);
...
var CssKeyframeRuleAst = (function (_super) {
    __extends$4(CssKeyframeRuleAst, _super);
...
var CssKeyframeDefinitionAst = (function (_super) {
    __extends$4(CssKeyframeDefinitionAst, _super);
...
var CssBlockDefinitionRuleAst = (function (_super) {
    __extends$4(CssBlockDefinitionRuleAst, _super);
...
var CssMediaQueryRuleAst = (function (_super) {
    __extends$4(CssMediaQueryRuleAst, _super);
...
var CssAtRulePredicateAst = (function (_super) {
    __extends$4(CssAtRulePredicateAst, _super);
...
var CssInlineRuleAst = (function (_super) {
    __extends$4(CssInlineRuleAst, _super);
...
var CssSelectorRuleAst = (function (_super) {
    __extends$4(CssSelectorRuleAst, _super);
...
var CssDefinitionAst = (function (_super) {
    __extends$4(CssDefinitionAst, _super);
...
var CssSelectorPartAst = (function (_super) {
    __extends$4(CssSelectorPartAst, _super);
...
var CssSelectorAst = (function (_super) {
    __extends$4(CssSelectorAst, _super);
...
var CssSimpleSelectorAst = (function (_super) {
    __extends$4(CssSimpleSelectorAst, _super);
...
var CssPseudoSelectorAst = (function (_super) {
    __extends$4(CssPseudoSelectorAst, _super);
...
var CssBlockAst = (function (_super) {
    __extends$4(CssBlockAst, _super);
...
var CssStylesBlockAst = (function (_super) {
    __extends$4(CssStylesBlockAst, _super);
...
var CssStyleSheetAst = (function (_super) {
    __extends$4(CssStyleSheetAst, _super);
...
var CssUnknownRuleAst = (function (_super) {
    __extends$4(CssUnknownRuleAst, _super);
...
var CssUnknownTokenListAst = (function (_super) {
    __extends$4(CssUnknownTokenListAst, _super);
...
var CssParseError = (function (_super) {
    __extends$3(CssParseError, _super);
...
var DirectiveSymbol = (function (_super) {
    __extends$2(DirectiveSymbol, _super);
    /**
    ...
    DirectiveSymbol.prototype.getTemplateAst = function () {
        ...
        try {
            ...
            if (metadata) {
                ...
                var parser = void 0;
                parser = new _angular_compiler.TemplateParser(new _angular_compiler.CompilerConfig, expressionParser, new _angular_compiler.DomElementSchemaRegistry(), htmlParser, undefined, []);
...
var ModuleSymbol = (function (_super) {
    __extends$5(ModuleSymbol, _super);
    function ModuleSymbol(program, symbol, metadataResolver, directiveNormalizer, resolver, pipeResolver, reflector, resourceResolver, projectSymbols) {
        ...
        _this.resourceResolver = resourceResolver;
        _this.projectSymbols = projectSymbols;
        _this.module = _this.metadataResolver.getNgModuleMetadata(symbol);
        return _this;
    }
...
var ContextSymbols = (function () {
    ...
    ContextSymbols.prototype.init = function () {
        ...
        this.metadataResolver = new _angular_compiler.CompileMetadataResolver(new _angular_compiler.CompilerConfig(), ngModuleResolver, this.directiveResolver, this.pipeResolver, summaryResolver, new _angular_compiler.DomElementSchemaRegistry(), this.directiveNormalizer, new _angular_core.ɵConsole(), new _angular_compiler.StaticSymbolCache(), this.reflector);
    };
